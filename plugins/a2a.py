...
class A2A(PluginFornitore):
    def __init__(self, csvfile='dati.csv', inputfolder='./', outputwriter=None):
        self.fornitore = 'fastweb'
        super(A2A,self).__init__(self.fornitore, csvfile, inputfolder, outputwriter)
    ...
    def parse_fattura(self, nomefile):
        ...
        nodo_pod = root.findall(".//FatturaElettronicaBody/DatiGenerali/DatiContratto/NumItem")
        print(nodo_pod)
...
register_plugin_fattura('a2a', A2A)
